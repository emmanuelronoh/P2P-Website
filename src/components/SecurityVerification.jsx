...
const SecurityVerification = ({ onComplete, onCancel }) => {
  ...
  const sendVerificationCode = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:8000/crypto/api/auth/send-verification-code/', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/crypto/api/auth/verify-code/', {
